...
;// ./src/components/ui/VisualLogo.tsx
const VisualLogo = () => {
  return /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, /* @__PURE__ */ React.createElement("div", { className: "relative w-10 h-10 flex-shrink-0" }, /* @__PURE__ */ React.createElement("svg", { viewBox: "0 0 40 40", fill: "none", xmlns: "http://www.w3.org/2000/svg", className: "w-full h-full" }, /* @__PURE__ */ React.createElement(
    "path",
    {
  ...
  ), /* @__PURE__ */ React.createElement("path", { d: "M12 4L16 12", stroke: "#eab308", strokeWidth: "2", strokeLinecap: "round" }), /* @__PURE__ */ React.createElement("circle", { cx: "12", cy: "24", r: "2.5", fill: "#22c55e" }), /* @__PURE__ */ React.createElement("path", { d: "M12 24L16 28", stroke: "#22c55e", strokeWidth: "2", strokeLinecap: "round" }), /* @__PURE__ */ React.createElement("circle", { cx: "16", cy: "18", r: "2.5", fill: "#22c55e" }), /* @__PURE__ */ React.createElement("path", { d: "M16 18L20 22", stroke: "#22c55e", strokeWidth: "2", strokeLinecap: "round" }), /* @__PURE__ */ React.createElement("circle", { cx: "24", cy: "20", r: "2.5", fill: "#22c55e" }), /* @__PURE__ */ React.createElement("path", { d: "M24 20L24 30", stroke: "#22c55e", strokeWidth: "2", strokeLinecap: "round" }), /* @__PURE__ */ React.createElement("circle", { cx: "28", cy: "26", r: "2.5", fill: "#22c55e" }), /* @__PURE__ */ React.createElement("path", { d: "M28 26L24 30", stroke: "#22c55e", strokeWidth: "2", strokeLinecap: "round" }))), /* @__PURE__ */ React.createElement("div", { className: "flex flex-col leading-none" }, /* @__PURE__ */ React.createElement("span", { className: "text-white font-extrabold text-lg tracking-tight leading-[0.8]" }, "RESUME"), /* @__PURE__ */ React.createElement("span", { className: "text-red-500 font-extrabold text-lg tracking-tight leading-[0.8]" }, "NUGGET")));
};
...
const Intro = () => {
  ...
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { className: "bg-[#0a0a0a] flex items-center justify-center" }, /* @__PURE__ */ React.createElement("div", { style: { transform: `scale(${scale})`, opacity } }, /* @__PURE__ */ React.createElement("div", { className: "transform scale-[3]" }, /* @__PURE__ */ React.createElement(VisualLogo, null))), /* @__PURE__ */ React.createElement("div", { style: {
    position: "absolute",
    bottom: 100,
    opacity: (0,esm.interpolate)(frame, [30, 50], [0, 1]),
    fontFamily: "sans-serif",
    color: "#84cc16"
    // lime-500
  }, className: "text-xl tracking-widest font-bold uppercase" }, "The Future of Resumes"));
};

// EXTERNAL MODULE: ./node_modules/react/index.js
var react = __webpack_require__(6540);
;// ./src/components/ui/VisualResumeForm.tsx

const VisualResumeForm = () => {
  return /* @__PURE__ */ react.createElement("div", { className: "w-full h-full bg-[#111] p-6 text-white border-r border-white/10 flex flex-col gap-6" }, /* @__PURE__ */ react.createElement("div", { className: "flex items-center justify-between border-b border-white/10 pb-4" }, /* @__PURE__ */ react.createElement("span", { className: "font-bold text-lg" }, "Personal Info"), /* @__PURE__ */ react.createElement("div", { className: "w-8 h-8 rounded-full bg-lime-500/20 flex items-center justify-center text-lime-400 text-xs" }, "60%")), /* @__PURE__ */ react.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ react.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ react.createElement("label", { className: "text-xs text-gray-500 uppercase tracking-wider font-bold" }, "Full Name"), /* @__PURE__ */ react.createElement("div", { className: "bg-white/5 border border-white/10 rounded-md p-2 text-sm text-white" }, "Nikhil Singh")), /* @__PURE__ */ react.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ react.createElement("label", { className: "text-xs text-gray-500 uppercase tracking-wider font-bold" }, "Headline"), /* @__PURE__ */ react.createElement("div", { className: "bg-white/5 border border-white/10 rounded-md p-2 text-sm text-white" }, "Full Stack Developer")), /* @__PURE__ */ react.createElement("div", { className: "space-y-1" }, /* @__PURE__ */ react.createElement("label", { className: "text-xs text-gray-500 uppercase tracking-wider font-bold" }, "Email"), /* @__PURE__ */ react.createElement("div", { className: "bg-white/5 border border-white/10 rounded-md p-2 text-sm text-white" }, "nikhil@example.com"))), /* @__PURE__ */ react.createElement("div", { className: "flex-1 bg-white/5 rounded-xl border border-white/10 p-4 flex items-center justify-center" }, /* @__PURE__ */ react.createElement("span", { className: "text-gray-500 text-xs" }, "AI Enhancement Active...")));
};
...
;// ./src/components/ui/VisualModernTemplate.tsx


const VisualModernTemplate = () => {
  return /* @__PURE__ */ react.createElement("div", { className: "w-[500px] h-[700px] bg-white text-black p-0 shadow-2xl flex flex-row overflow-hidden text-[10px]" }, /* @__PURE__ */ react.createElement("div", { className: "w-1/3 bg-slate-900 text-white p-6 flex flex-col gap-6" }, /* @__PURE__ */ react.createElement("div", { className: "w-20 h-20 bg-slate-700 rounded-full mx-auto" }), /* @__PURE__ */ react.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ react.createElement("div", { className: "font-bold border-b border-slate-700 pb-1 mb-2" }, "CONTACT"), /* @__PURE__ */ react.createElement("div", { className: "flex items-center gap-2 text-slate-300" }, /* @__PURE__ */ react.createElement(Mail, { size: 10 }), " nikhil@example.com"), /* @__PURE__ */ react.createElement("div", { className: "flex items-center gap-2 text-slate-300" }, /* @__PURE__ */ react.createElement(Phone, { size: 10 }), " +1 234 567 890"), /* @__PURE__ */ react.createElement("div", { className: "flex items-center gap-2 text-slate-300" }, /* @__PURE__ */ react.createElement(MapPin, { size: 10 }), " San Francisco, CA")), /* @__PURE__ */ react.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ react.createElement("div", { className: "font-bold border-b border-slate-700 pb-1 mb-2" }, "SKILLS"), /* @__PURE__ */ react.createElement("div", { className: "flex flex-wrap gap-1" }, ["React", "Next.js", "TypeScript", "Node.js", "Tailwind CSS", "PostgreSQL"].map((s) => /* @__PURE__ */ react.createElement("span", { key: s, className: "bg-slate-800 px-2 py-1 rounded text-[8px]" }, s))))), /* @__PURE__ */ react.createElement("div", { className: "w-2/3 p-8 flex flex-col gap-6" }, /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement("h1", { className: "text-3xl font-bold text-slate-900 mb-1" }, "NIKHIL SINGH"), /* @__PURE__ */ react.createElement("p", { className: "text-slate-500 font-medium" }, "FULL STACK DEVELOPER")), /* @__PURE__ */ react.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ react.createElement("h2", { className: "font-bold text-slate-900 border-b border-slate-200 pb-1" }, "PROFESSIONAL SUMMARY"), /* @__PURE__ */ react.createElement("p", { className: "text-slate-600 leading-relaxed" }, "Innovative Full Stack Developer with 5+ years of experience building high-performance web applications. Specialized in React ecosystem and AI integration. Proven track record of delivering scalable solutions.")), /* @__PURE__ */ react.createElement("div", { className: "space-y-4" }, /* @__PURE__ */ react.createElement("h2", { className: "font-bold text-slate-900 border-b border-slate-200 pb-1" }, "EXPERIENCE"), /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement("div", { className: "flex justify-between font-bold text-slate-800" }, /* @__PURE__ */ react.createElement("span", null, "Senior Developer"), /* @__PURE__ */ react.createElement("span", null, "2021 - Present")), /* @__PURE__ */ react.createElement("div", { className: "text-slate-500 mb-1" }, "TechCorp Inc."), /* @__PURE__ */ react.createElement("ul", { className: "list-disc pl-4 text-slate-600 space-y-1" }, /* @__PURE__ */ react.createElement("li", null, "Led a team of 5 developers to rebuild the core platform using Next.js."), /* @__PURE__ */ react.createElement("li", null, "Implemented AI features using NVIDIA NIM, increasing user engagement by 40%."), /* @__PURE__ */ react.createElement("li", null, "Optimized database queries reducing load times by 60%."))), /* @__PURE__ */ react.createElement("div", null, /* @__PURE__ */ react.createElement("div", { className: "flex justify-between font-bold text-slate-800" }, /* @__PURE__ */ react.createElement("span", null, "Web Developer"), /* @__PURE__ */ react.createElement("span", null, "2019 - 2021")), /* @__PURE__ */ react.createElement("div", { className: "text-slate-500 mb-1" }, "StartUp Flow"), /* @__PURE__ */ react.createElement("ul", { className: "list-disc pl-4 text-slate-600 space-y-1" }, /* @__PURE__ */ react.createElement("li", null, "Developed responsive UI components using React and Tailwind CSS."), /* @__PURE__ */ react.createElement("li", null, "Integrated Stripe payments processing $1M+ annually."))))));
};

;// ./src/scenes/BuilderScene.tsx
...
const BuilderScene = () => {
  ...
  const previewScale = (0,esm.spring)({
    frame: frame - 10,
    fps: 30,
    from: 0.8,
    to: 1,
  ...
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { className: "bg-[#0a0a0a] flex flex-row" }, /* @__PURE__ */ React.createElement("div", { style: { width: "40%", transform: `translateX(${formOffset}px)` }, className: "h-full z-10 border-r border-white/20 box-border" }, /* @__PURE__ */ React.createElement(VisualResumeForm, null)), /* @__PURE__ */ React.createElement("div", { className: "flex-1 bg-gray-800 flex items-center justify-center relative overflow-hidden" }, /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 bg-grid-white/[0.05] bg-[length:20px_20px]" }), /* @__PURE__ */ React.createElement("div", { style: { transform: `scale(${previewScale})` }, className: "shadow-2xl" }, /* @__PURE__ */ React.createElement(VisualModernTemplate, null))), /* @__PURE__ */ React.createElement("div", { className: "absolute top-10 right-10 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl" }, /* @__PURE__ */ React.createElement("h2", { className: "text-white font-bold text-2xl" }, "Real-time Preview")));
};
...
;// ./src/components/ui/VisualJobMatch.tsx


const CardHeader = ({ children, className }) => /* @__PURE__ */ react.createElement("div", { className: `flex flex-col space-y-1.5 p-6 ${className}` }, children);
const CardTitle = ({ children, className }) => /* @__PURE__ */ react.createElement("h3", { className: `font-semibold leading-none tracking-tight ${className}` }, children);
const CardDescription = ({ children, className }) => /* @__PURE__ */ react.createElement("p", { className: `text-sm text-muted-foreground ${className}` }, children);
const Button = ({ children, className, variant }) => /* @__PURE__ */ react.createElement("button", { className: `inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 h-9 px-4 py-2 ${variant === "outline" ? "border border-input bg-background shadow-sm hover:bg-accent hover:text-accent-foreground" : "bg-primary text-primary-foreground shadow hover:bg-primary/90"} ${className}` }, children);
const Progress = ({ value, className }) => /* @__PURE__ */ react.createElement("div", { className: `relative h-2 w-full overflow-hidden rounded-full bg-primary/20 ${className}` }, /* @__PURE__ */ react.createElement("div", { className: "h-full w-full flex-1 bg-primary transition-all", style: { transform: `translateX(-${100 - (value || 0)}%)` } }));
const VisualJobMatch = ({ score = 0, showResult = false }) => {
  return /* @__PURE__ */ react.createElement("div", { className: "h-full flex flex-col space-y-4 bg-black/80 rounded-xl border border-white/10 text-white p-4 w-[500px]" }, /* @__PURE__ */ react.createElement(CardHeader, { className: "p-0 pb-4" }, /* @__PURE__ */ react.createElement(CardTitle, { className: "flex items-center gap-2 text-xl" }, /* @__PURE__ */ react.createElement(Search, { className: "h-6 w-6 text-lime-400" }), " Job Match Analysis"), /* @__PURE__ */ react.createElement(CardDescription, { className: "text-gray-400" }, "AI-powered analysis of your resume vs job description.")), /* @__PURE__ */ react.createElement("div", { className: "flex-1 space-y-4" }, showResult ? /* @__PURE__ */ react.createElement("div", { className: "space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700" }, /* @__PURE__ */ react.createElement("div", { className: "text-center space-y-2" }, /* @__PURE__ */ react.createElement("span", { className: "text-6xl font-black text-lime-400" }, Math.round(score), "%"), /* @__PURE__ */ react.createElement(Progress, { value: score, className: "h-3 bg-gray-800" }), /* @__PURE__ */ react.createElement("p", { className: "text-sm text-gray-400" }, score >= 80 ? "Great Match!" : "Needs Improvement")), /* @__PURE__ */ react.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ react.createElement("h4", { className: "font-semibold text-sm flex items-center gap-2 text-white" }, /* @__PURE__ */ react.createElement(CircleAlert, { className: "h-4 w-4 text-orange-500" }), " Missing Keywords"), /* @__PURE__ */ react.createElement("div", { className: "flex flex-wrap gap-2" }, /* @__PURE__ */ react.createElement("span", { className: "bg-orange-900/30 text-orange-400 text-xs px-2 py-1 rounded-full border border-orange-500/30" }, "React Native"), /* @__PURE__ */ react.createElement("span", { className: "bg-orange-900/30 text-orange-400 text-xs px-2 py-1 rounded-full border border-orange-500/30" }, "GraphQL"))), /* @__PURE__ */ react.createElement("div", { className: "space-y-2" }, /* @__PURE__ */ react.createElement("h4", { className: "font-semibold text-sm flex items-center gap-2 text-white" }, /* @__PURE__ */ react.createElement(CircleCheckBig, { className: "h-4 w-4 text-green-500" }), " Matching Keywords"), /* @__PURE__ */ react.createElement("div", { className: "flex flex-wrap gap-2" }, ["TypeScript", "Next.js", "Tailwind", "Node.js", "PostgreSQL"].map((kw, i) => /* @__PURE__ */ react.createElement("span", { key: i, className: "bg-green-900/30 text-green-400 text-xs px-2 py-1 rounded-full border border-green-500/30" }, kw))))) : /* @__PURE__ */ react.createElement("div", { className: "space-y-4 opacity-50" }, /* @__PURE__ */ react.createElement("div", { className: "h-32 bg-white/5 rounded-md border border-white/10 p-4 text-gray-500 text-sm" }, "Paste Job Description here..."), /* @__PURE__ */ react.createElement(Button, { className: "w-full bg-lime-500 text-black hover:bg-lime-400" }, /* @__PURE__ */ react.createElement(Bot, { className: "mr-2 h-4 w-4" }), " Analyze Match"))));
};

;// ./src/scenes/AIScene.tsx


const AIScene = () => {
  const frame = (0,esm.useCurrentFrame)();
  const { fps } = (0,esm.useVideoConfig)();
  const score = (0,esm.interpolate)(frame, [0, 60], [0, 92], {
    extrapolateRight: "clamp"
  });
  const showResult = frame > 10;
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { className: "bg-[#0a0a0a] flex items-center justify-center relative" }, /* @__PURE__ */ React.createElement("div", { className: "absolute inset-0 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-lime-900/20 via-[#0a0a0a] to-[#0a0a0a]" }), /* @__PURE__ */ React.createElement("div", { className: "z-10 transform scale-125" }, /* @__PURE__ */ React.createElement(VisualJobMatch, { score, showResult })), /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-20 text-center" }, /* @__PURE__ */ React.createElement("h2", { className: "text-4xl font-black text-white mb-2 tracking-tighter" }, "AI-POWERED OPTIMIZATION"), /* @__PURE__ */ React.createElement("p", { className: "text-gray-400" }, "Target any job description with precision")));
};

;// ./src/scenes/TemplateScene.tsx


const TemplateScene = () => {
  const frame = (0,esm.useCurrentFrame)();
  const xOffset = (0,esm.interpolate)(frame, [0, 90], [0, -300]);
  return /* @__PURE__ */ React.createElement(esm.AbsoluteFill, { className: "bg-[#0a0a0a] flex flex-col items-center justify-center overflow-hidden" }, /* @__PURE__ */ React.createElement("h2", { className: "text-4xl font-black text-white mb-10 z-10 bg-black/50 px-6 py-2 rounded-xl backdrop-blur" }, "PREMIUM TEMPLATES"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-10 absolute", style: { transform: `translateX(${xOffset}px) rotate(-5deg)` } }, /* @__PURE__ */ React.createElement("div", { className: "scale-75 opacity-50" }, /* @__PURE__ */ React.createElement(VisualModernTemplate, null)), /* @__PURE__ */ React.createElement("div", { className: "scale-100 shadow-[0_0_50px_rgba(132,204,22,0.3)] border-4 border-lime-500/50 rounded-lg" }, /* @__PURE__ */ React.createElement(VisualModernTemplate, null)), /* @__PURE__ */ React.createElement("div", { className: "scale-75 opacity-50" }, /* @__PURE__ */ React.createElement(VisualModernTemplate, null)), /* @__PURE__ */ React.createElement("div", { className: "scale-75 opacity-50" }, /* @__PURE__ */ React.createElement(VisualModernTemplate, null))), /* @__PURE__ */ React.createElement("div", { className: "absolute bottom-10 right-10 bg-lime-500 text-black font-black text-xl px-6 py-3 rounded-full shadow-lg" }, "100% FREE"));
};
...
const Main = () => {
  return /* @__PURE__ */ React.createElement(esm.Series, null, /* @__PURE__ */ React.createElement(esm.Series.Sequence, { durationInFrames: 90 }, /* @__PURE__ */ React.createElement(Intro, null)), /* @__PURE__ */ React.createElement(esm.Series.Sequence, { durationInFrames: 150 }, /* @__PURE__ */ React.createElement(BuilderScene, null)), /* @__PURE__ */ React.createElement(esm.Series.Sequence, { durationInFrames: 180 }, /* @__PURE__ */ React.createElement(AIScene, null)), /* @__PURE__ */ React.createElement(esm.Series.Sequence, { durationInFrames: 180 }, /* @__PURE__ */ React.createElement(TemplateScene, null)));
};
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@tailwind base;\r\n@tailwind components;\r\n@tailwind utilities;\r\n\r\nbody {\r\n    background-color: #000;\r\n    color: #fff;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA,cAAc;AACd,oBAAoB;AACpB,mBAAmB;;AAEnB;IACI,sBAAsB;IACtB,WAAW;AACf","sourcesContent":["@tailwind base;\r\n@tailwind components;\r\n@tailwind utilities;\r\n\r\nbody {\r\n    background-color: #000;\r\n    color: #fff;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "ad-video:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkad_video"] = self["webpackChunkad_video"] || [];
